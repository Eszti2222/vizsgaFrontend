      ...
      try {
        ...
        if (mounted) {
          ...
          if (normalized.length > 0) {
            setSelectedType(normalized[0].type);
          }
        }
      } catch (err) {
        console.error(err);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 422) {
        ...
        setError(
          err.response?.data?.message || "Hiba történt a feltöltés során.",
        );
      }
    } finally {
      setLoading(false);
          ...
          <form className="upload-form wireframe" onSubmit={handleSubmit}>
            <div className="upload-grid">
              ...
              <div className="upload-right">
                <div className="form-group">
                  <label htmlFor="taj">
                    TAJ szám szerinti keresés páciensekre
                  </label>
                  <input
                    id="taj"
                    type="text"
                ...
                <div className="form-group">
                  ...
                  >
                    {typesLoading && (
                      <option value="">Típusok betöltése...</option>
                    )}
                ...
                <button
                  ...
                  type="submit"
                  disabled={
                    loading || typesLoading || documentTypes.length === 0
                  }
                >
